...
import { fetchVendorReportList } from 'store/reports/reportsActions';
...
function VendorReport(){
    ...
    const vendorData = useSelector((state) => state.reports.vReportList);
    ...
    useEffect(()=>{
        dispatch(fetchVendorReportList(selectVendor))
        dispatch(fetchVendorList())
    }, [dispatch, selectVendor])
        ...
        <div className='report-main-box'>
            <div className='report-toolbar'>
                <FormControl sx={{minWidth: 300 }}>
                    <InputLabel id="selectVendor">Select Vendor</InputLabel>
                    <Select
                        labelId="selectVendor"
                        id="selectVendor"
                        value={selectVendor}
                        label="Select Vendor"
                        onChange={handelSelectVendor}
                    >
                        <MenuItem value="">
                            <em>Select Vendor</em>
                        </MenuItem>
                        {vendorList === null ? null : vendorList.map((item, i)=>{
