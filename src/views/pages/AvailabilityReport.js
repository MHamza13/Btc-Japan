...
import { fetchAvailabilityReporttList } from 'store/reports/reportsActions';
...
function AvailabilityReport(){
    ...
    const vendorData = useSelector((state) => state.reports.aVReportList);
    ...
    useEffect(()=>{
        dispatch(fetchAvailabilityReporttList(selectVendor))
    ...
    const handelDownloadPdf = () =>{
        const fileName = 'Availability Report';
